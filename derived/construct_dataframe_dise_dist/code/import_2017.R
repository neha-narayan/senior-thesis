...
outdata <- "C:/Users/Neha Narayan/Desktop/GitHub/senior-thesis/derived/construct_dataframe_dise_dist/output/csv"
yeardirs <- dir(root, pattern = "", full.names = TRUE)

dir <- "C:/Users/Neha Narayan/Desktop/GitHub/senior-thesis/raw/DISE_school_data/2017-18"
...
basic_path <- toString(paste(outdata, "/basic", "_2017", ".csv", sep = ""))
...
general_path <- toString(paste(outdata, "/general", "_2017", ".csv", sep = ""))
...
facility_path <- paste(outdata, "/facility", "_2017", ".csv", sep = "")
...
repeaters_path <- paste(outdata, "/repeaters", "_2017", ".csv", sep = "")
...
enrollment_path <- paste(outdata, "/enrollment", "_2017", ".csv", sep = "")
...
scenrollment_path <- paste(outdata, "/scenrollment", "_2017", ".csv", sep = "")
...
stenrollment_path <- paste(outdata, "/stenrollment", "_2017", ".csv", sep = "")
...
obcenrollment_path <- paste(outdata, "/obcenrollment", "_2017", ".csv", sep = "")
...
disabledenrollment_path <- paste(outdata, "/disabledenrollment", "_2017", ".csv", sep = "")
...
rte_path <- paste(outdata, "/rte", "_2017", ".csv", sep = "")
...
teachers_path <- paste(outdata, "/teachers", "_2017", ".csv", sep = "")
